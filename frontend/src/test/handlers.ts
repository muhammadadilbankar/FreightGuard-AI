...
import { anomalyDetail, anomalyList, assistantResponse, evaluation, healthReady, metrics, rootCause, runResponse, summary, timeline } from './fixtures'
...
export const handlers = [
  ...
  http.post(`${api}/api/assistant/query`, () => HttpResponse.json(assistantResponse)),
