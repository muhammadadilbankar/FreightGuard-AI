...
export const summary: SummaryEnvelope = { data: { shipment_count: 100, route_count: 2, route_type_count: 1, weekly_record_count: 20, candidate_count: 1, justified_count: 0, partially_explained_count: 0, unexplained_count: 1, analysis_from: '2024-01-01', analysis_to: '2024-03-04', anomaly_threshold_percent: 20, explanation_mode: 'template', evaluation_status: 'pass', final_csv_sha256: 'a'.repeat(64), run_state: 'succeeded' }, meta }
