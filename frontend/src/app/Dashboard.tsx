...
export function Dashboard({ onRun }: { onRun: () => void }) {
  ...
  const observed = [queue.data?.meta.snapshot_id, unexplained.data?.meta.snapshot_id, partial.data?.meta.snapshot_id, timeline.data?.meta.snapshot_id, detail.data?.meta.snapshot_id, evaluation.data?.meta.snapshot_id, metrics.data?.meta.snapshot_id]
